        ...
        config = function()
            require('telescope').setup {
                defaults = {
                    ...
                    layout_config = {
                        width = 0.9, -- overall width (0.9 = 90% of screen)
                        height = 0.85, -- overall height
                        preview_width = 0.6, -- make right preview larger
                        prompt_position = 'top',
                        horizontal = {
                            preview_width = 0.6, -- right panel wider
                            results_width = 0.4, -- left panel smaller
                        },
                        anchor = 'CENTER', -- center the layout
                    },
                    borderchars = {
                        prompt = { '─', '│', '─', '│', '╭', '╮', '╯', '╰' },
                        results = { '─', '│', '─', '│', '╭', '╮', '╯', '╰' },
